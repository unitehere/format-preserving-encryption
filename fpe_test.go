...
func TestFF1Encrypt1(t *testing.T) {
	...
	ff1 := NewFF1("2B7E151628AED2A6ABF7158809CF4F3C", 10, 1, 20, 16)
...
func TestFF1Encrypt3(t *testing.T) {
	...
	ff1 := NewFF1("2B7E151628AED2A6ABF7158809CF4F3C", 36, 1, 20, 16)
...
func TestFF1Encrypt4(t *testing.T) {
	...
	ff1 := NewFF1("2B7E151628AED2A6ABF7158809CF4F3CEF4359D8D580AA4F", 10, 1, 20, 16)
	msg, err := ff1.Encrypt("0123456789", []byte{})
	assertNoError(t, err)
...
func TestFF1Encrypt6(t *testing.T) {
	...
	ff1 := NewFF1("2B7E151628AED2A6ABF7158809CF4F3CEF4359D8D580AA4F", 36, 1, 20, 16)
	msg, err := ff1.Encrypt("0123456789abcdefghi", []byte{0x37, 0x37, 0x37, 0x37, 0x70, 0x71, 0x72, 0x73, 0x37, 0x37, 0x37})
	assertNoError(t, err)
...
func TestFF1Encrypt7(t *testing.T) {
	...
	ff1 := NewFF1("2B7E151628AED2A6ABF7158809CF4F3CEF4359D8D580AA4F7F036D6F04FC6A94", 10, 1, 20, 16)
	msg, err := ff1.Encrypt("0123456789", []byte{})
	assertNoError(t, err)
...
func TestFF1Encrypt9(t *testing.T) {
	...
	ff1 := NewFF1("2B7E151628AED2A6ABF7158809CF4F3CEF4359D8D580AA4F7F036D6F04FC6A94", 36, 1, 20, 16)
	msg, err := ff1.Encrypt("0123456789abcdefghi", []byte{0x37, 0x37, 0x37, 0x37, 0x70, 0x71, 0x72, 0x73, 0x37, 0x37, 0x37})
	assertNoError(t, err)
...
func TestFF1EncryptShortMessage(t *testing.T) {
	...
	ff1 := NewFF1("2B7E151628AED2A6ABF7158809CF4F3CEF4359D8D580AA4F7F036D6F04FC6A94", 36, 5, 20, 16)
...
func TestFF1EncryptLongTweak(t *testing.T) {
	t.Log("Testing FF1 encryption with message that is too long... ")
	ff1 := NewFF1("2B7E151628AED2A6ABF7158809CF4F3CEF4359D8D580AA4F7F036D6F04FC6A94", 36, 5, 20, 10)
...
func TestFF3Encrypt1(t *testing.T) {
	...
	ff3 := NewFF3("EF4359D8D580AA4F7F036D6F04FC6A94", 10, 1, 20)
...
func TestFF3Encrypt3(t *testing.T) {
	...
	ff3 := NewFF3("EF4359D8D580AA4F7F036D6F04FC6A94", 10, 1, 30)
...
func TestFF3Encrypt5(t *testing.T) {
	...
	ff3 := NewFF3("EF4359D8D580AA4F7F036D6F04FC6A94", 26, 1, 30)
...
func TestFF3Encrypt6(t *testing.T) {
	...
	ff3 := NewFF3("EF4359D8D580AA4F7F036D6F04FC6A942B7E151628AED2A6", 10, 1, 20)
	msg, err := ff3.Encrypt("890121234567890000", [8]byte{0xD8, 0xE7, 0x92, 0x0A, 0xFA, 0x33, 0x0A, 0x73})
	assertNoError(t, err)
...
func TestFF3Encrypt8(t *testing.T) {
	...
	ff3 := NewFF3("EF4359D8D580AA4F7F036D6F04FC6A942B7E151628AED2A6", 10, 1, 30)
	msg, err := ff3.Encrypt("89012123456789000000789000000", [8]byte{0xD8, 0xE7, 0x92, 0x0A, 0xFA, 0x33, 0x0A, 0x73})
	assertNoError(t, err)
...
func TestFF3Encrypt10(t *testing.T) {
	...
	ff3 := NewFF3("EF4359D8D580AA4F7F036D6F04FC6A942B7E151628AED2A6", 26, 1, 30)
	msg, err := ff3.Encrypt("0123456789abcdefghi", [8]byte{0x9A, 0x76, 0x8A, 0x92, 0xF6, 0x0E, 0x12, 0xD8})
	assertNoError(t, err)
...
func TestFF3Encrypt11(t *testing.T) {
	...
	ff3 := NewFF3("EF4359D8D580AA4F7F036D6F04FC6A942B7E151628AED2A6ABF7158809CF4F3C", 10, 1, 20)
	msg, err := ff3.Encrypt("890121234567890000", [8]byte{0xD8, 0xE7, 0x92, 0x0A, 0xFA, 0x33, 0x0A, 0x73})
	assertNoError(t, err)
...
func TestFF3Encrypt13(t *testing.T) {
	...
	ff3 := NewFF3("EF4359D8D580AA4F7F036D6F04FC6A942B7E151628AED2A6ABF7158809CF4F3C", 10, 1, 30)
	msg, err := ff3.Encrypt("89012123456789000000789000000", [8]byte{0xD8, 0xE7, 0x92, 0x0A, 0xFA, 0x33, 0x0A, 0x73})
	assertNoError(t, err)
...
func TestFF3Encrypt15(t *testing.T) {
	...
	ff3 := NewFF3("EF4359D8D580AA4F7F036D6F04FC6A942B7E151628AED2A6ABF7158809CF4F3C", 26, 1, 30)
	msg, err := ff3.Encrypt("0123456789abcdefghi", [8]byte{0x9A, 0x76, 0x8A, 0x92, 0xF6, 0x0E, 0x12, 0xD8})
	assertNoError(t, err)
...
func TestFF3EncryptNoMessage(t *testing.T) {
	...
	ff3 := NewFF3("2B7E151628AED2A6ABF7158809CF4F3CEF4359D8D580AA4F7F036D6F04FC6A94", 36, 1, 20)
...
func TestFF3EncryptShortMessage(t *testing.T) {
	...
	ff3 := NewFF3("2B7E151628AED2A6ABF7158809CF4F3CEF4359D8D580AA4F7F036D6F04FC6A94", 36, 5, 20)
