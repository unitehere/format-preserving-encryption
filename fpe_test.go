...
func TestFF1EncryptShortMessage(t *testing.T) {
	...
	ff1 := setupFF1("2B7E151628AED2A6ABF7158809CF4F3CEF4359D8D580AA4F7F036D6F04FC6A94", 36, 5, 20, 16)
...
func TestFF1EncryptLongTweak(t *testing.T) {
	t.Log("Testing FF1 encryption with message that is too long... ")
	ff1 := setupFF1("2B7E151628AED2A6ABF7158809CF4F3CEF4359D8D580AA4F7F036D6F04FC6A94", 36, 5, 20, 10)
